    ...
    <nav className="bg-white dark:bg-gray-800 shadow-lg sticky top-0 z-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className={`${desktopNavClass} items-center gap-6 xl:gap-8 shrink-0`}>
            {NAV_LINKS.map((link) => (
          ...
          <div className="flex items-center gap-1 sm:gap-2 lg:gap-3 shrink-0">
            ...
            >
              <i
                className={`fas text-lg sm:text-xl ${isDarkMode ? 'fa-sun' : 'fa-moon'}`}
                aria-hidden="true"
              />
            </button>
            ...
            <button
              ...
              className={`${mobileToggleClass} p-2 text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400`}
        ...
        {isMobileMenuOpen && (
          <div className={`${mobileMenuClass} border-t border-gray-200 dark:border-gray-700 py-4`}>
